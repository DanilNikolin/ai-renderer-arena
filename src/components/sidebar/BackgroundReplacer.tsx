  ...
  return (
    <>
      <div className="space-y-4 pt-3">
        {/* Блок загрузки */}
        <div>
          <Label title="Background Reference" />
          <input
            type="file"
            ref={fileInputRef}
          ...
          >
            {previewUrl ? 'Replace Background' : '+ Upload Background'}
          </button>
        ...
        {/* Блок выбора целей */}
        <div>
          <Label title="Replacement Targets" />
        ...
        <div>
          <Label title={referenceFile ? "Clarification (optional)" : "Background Description (if no file)"} />
          <div className="relative">
            <textarea
              ...
              placeholder={referenceFile ? "Example: make the forest more foggy" : "Example: snowy mountains at sunrise"}
            />
